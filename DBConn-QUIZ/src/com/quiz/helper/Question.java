...
public class Question {
	...
	public Question(int id, String question, String option_1, String option_2, String option_3, String option_4,
			String answer,String answer_idx) {
		super();
		this.id = id;
	...
	public String toString() {
		return "Question [id=" + id + ", question=" + question + ", option_1=" + option_1 + ", option_2=" + option_2
				+ ", option_3=" + option_3 + ", option_4=" + option_4 + ", answer_idx=" + answer_idx + ", answer=" + answer + "]";
	}
	public int getId() {
		return id;
	}
